**StudySphere** is a decentralized application (dApp) built on the Internet Computer (IC) using Motoko, designed to facilitate collaborative learning through study groups, note-sharing as non-fungible tokens (NFTs), and a token-based reward system.
